...
if __name__ == "__main__":
    ...
    console = Console()
    console.print(f"Path: [underline]{os.getcwd()}[/underline]\n")
    ...
    for dir in directories:
        console.print(f"{dir}", style="blue")
    ...
    if oldfiles:
        dat_del = input(
            f"Dateien älter als {oldfilesdays} Tage in Ordner {dir_to_delete} verschieben? [n] "
        )
